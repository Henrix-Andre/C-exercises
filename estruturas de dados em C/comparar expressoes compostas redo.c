...
void comparar_parenteses(char * expr, pilha * comp, pilha * certo){
	int i;
...
void comparar_colchetes(char * expr, pilha * comp, pilha * certo){
	int i;
	for(i = 0; i < strlen(expr); i++){
		if(expr[i] == '['){
			push(comp, 1);
...
void comparar_elChavo(char * expr, pilha * comp, pilha * certo){
	int i;
	for(i = 0; i < strlen(expr); i++){
		if(expr[i] == '{'){
			push(comp, 1);
